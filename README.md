...
<span align="center">Диаграмма состояний приложения</span>

![Схема 2. Диаграмма кооперации слоев приложения на примере задачи построения графика](/presentation/img/scheme2_cooperation.png)
<span align="center">Диаграмма кооперации слоев приложения на примере задачи построения графика</span>

![Схема 3. Диаграмма компонентов приложения](/img/scheme3_components.png)
<span align="center">Диаграмма компонентов приложения</span>

![Схема 4. Диаграмма классов слоя "модель"](/img/scheme4_classes_model.png)
<span align="center">Диаграмма классов слоя "модель"</span>

![Схема 5. Диаграмма классов слоя "представление"](/img/scheme5_classes_view.png)
<span align="center">Диаграмма классов слоя "представление"</span>

![Схема 6. Диаграмма классов слоя "контроллер"](/img/scheme6_classes_controller.png)
<span align="center">Диаграмма классов слоя "контроллер"</span>

![Схема 7. Диаграмма последовательности на примере построения графика](/img/scheme7_sequence.png)
<span align="center">Диаграмма последовательности на примере построения графика</span>
